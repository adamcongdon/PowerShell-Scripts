...
# static path from the proxy server
...
#VixDiskLibSample.exe -writebench 1024 -host 10.3.41.8 -user x -password y -mode nbd -vm "v" -ssmoref "s" -thumb "F2:9D:D7:8D:F1:0E:1E:15:B0:FA:CD:AC:29:ED:9E:98:1A:25:81:99" -initex "d" -libdir "C:\Program Files (x86)\Veeam\Backup Transport\x64\vddk_6_0" Q